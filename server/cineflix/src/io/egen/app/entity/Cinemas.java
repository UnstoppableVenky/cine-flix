...
@Entity
@Table
@NamedQueries({@NamedQuery(name = "Cinemas.findAll", query = "SELECT c from Cinemas c ORDER BY c.title"),
	  @NamedQuery(name = "Cinemas.findByTitle", query = "SELECT c from Cinemas c where c.title=:ptitle")
})
public class Cinemas {
	...
	public Number getMetascore() {
		return metascore;
	}
	public void setMetascore(Number metascore) {
	...
	public String toString() {
		return "Cinemas [title=" + title + ", year=" + year + ", rated=" + rated + ", released=" + released
